"""
update_addrs_v8_42.py — Replace all V8.41 contract addresses with V8.42 in frontend HTML files.
Run from CryptoNova-Testnet-App: python update_addrs_v8_42.py
"""
import os, json
CONTRACTS_DIR = r"C:\CryptoNite-Smart-Contracts\CryptoNova"
BASE          = r"C:\CryptoNova-Testnet-App"
OLD_JSON = os.path.join(CONTRACTS_DIR, "scripts", "deployed_addresses_v8_41_orig.json")
NEW_JSON = os.path.join(CONTRACTS_DIR, "scripts", "deployed_addresses_v8_42.json")
...
with open(OLD_JSON, "r", encoding="utf-16") as f:
...
REPLACEMENTS.append(("[v8.41]", "[v8.42]"))
REPLACEMENTS.append(("v8.41", "v8.42"))
...
print("  2. git add -A && git commit -m 'chore(V8.42): update all contract addresses'")
